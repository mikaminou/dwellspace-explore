...
const arTranslations = {
  ...
  'property.in': 'في',
  'property.luxury': 'فاخر',
  'property.beds': 'غرف',
  'property.experience': 'تجربة',
  'property.smart_home': 'منزل ذكي',
  'property.floor_ceiling': 'نوافذ من الأرض إلى السقف',
  'property.private_terrace': 'تراس خاص',
  'property.secure_parking': 'موقف سيارات آمن',
  'property.concierge': 'خدمة الكونسيرج',
  'property.wine_cellar': 'قبو نبيذ',
  'property.private_elevator': 'مصعد خاص',
  'property.indoor_pool': 'مسبح داخلي',
