...
export default function PropertyEdit() {
  ...
  useEffect(() => {
    console.log("PropertyEdit: Auth state", { session, isLoaded, profileData, isProfileLoaded, userRole, isSellerOrAgent });
    ...
    if (isProfileLoaded) {
      ...
      if (!isSellerOrAgent) {
        ...
        toast.error("Only sellers and agents can edit properties");
        navigate("/dashboard");
      }
    }
